...
//      translate(kart: sender.view, by: view.frame.width)
  ...
  private func moveKart(using gestureRecognizer: UIPanGestureRecognizer) {
    // YOUR CODE HERE
      let location = gestureRecognizer.location(in: view) // gets location of the gesture
      let kartView = gestureRecognizer.view // gets reference to the kart
